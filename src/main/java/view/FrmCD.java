...
public class FrmCD extends JInternalFrame {

    private JTextField txtTitulo, txtUnidades, txtArtista, txtGenero, txtDuracion, txtCanciones;
    ...
    public FrmCD() {
        super("Registro de CDs", true, true, true, true);
        setSize(550, 500);
        ...
        JLabel lblHeader = new JLabel("Sistema de Mediateca — Registro de CDs de Audio");
        ...
        añadirFila(pnlDatos, gbc, 0, "Título del Álbum:", txtTitulo = new JTextField());
        añadirFila(pnlDatos, gbc, 1, "Unidades Disponibles:", txtUnidades = new JTextField());
        añadirFila(pnlDatos, gbc, 2, "Artista / Banda:", txtArtista = new JTextField());
        añadirFila(pnlDatos, gbc, 3, "Género Musical:", txtGenero = new JTextField());
        añadirFila(pnlDatos, gbc, 4, "Duración (min):", txtDuracion = new JTextField());
        añadirFila(pnlDatos, gbc, 5, "No. de Canciones:", txtCanciones = new JTextField());
