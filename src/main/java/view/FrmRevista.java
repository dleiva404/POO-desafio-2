...
public class FrmRevista extends JInternalFrame {

    private JTextField txtTitulo, txtUnidades, txtEditorial, txtIssn, txtEdicion, txtAnio;
    ...
    public FrmRevista() {
        ...
        JLabel lblHeader = new JLabel("Sistema de Mediateca — Registro de Revistas");
        ...
        añadirFila(pnlDatos, gbc, 0, "Título Revista:", txtTitulo = new JTextField());
        añadirFila(pnlDatos, gbc, 1, "Unidades Disponibles:", txtUnidades = new JTextField());
        añadirFila(pnlDatos, gbc, 2, "Editorial:", txtEditorial = new JTextField());
        añadirFila(pnlDatos, gbc, 3, "ISSN:", txtIssn = new JTextField());
        añadirFila(pnlDatos, gbc, 4, "No. Edición:", txtEdicion = new JTextField());
        añadirFila(pnlDatos, gbc, 5, "Año Publicación:", txtAnio = new JTextField());
        ...
        btnGuardar = new JButton("Guardar Revista");
    ...
    private void añadirFila(JPanel pnl, GridBagConstraints gbc, int fila, String texto, JTextField campo) {
        ...
        campo.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(80, 80, 80)), BorderFactory.createEmptyBorder(5, 8, 5, 8)));
        pnl.add(campo, gbc);
    }
